...
Revision ID: 010_weekly_summaries
...
revision: str = "010_weekly_summaries"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_weekly_symptom_summaries_patient_id",
        "weekly_symptom_summaries",
        ["patient_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_weekly_symptom_summaries_calculated_at",
        "weekly_symptom_summaries",
        ["calculated_at"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_weekly_symptom_summaries_calculated_at", table_name="weekly_symptom_summaries"
    )
